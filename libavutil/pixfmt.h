...
enum AVPixelFormat {
    ...
    AV_PIX_FMT_YUV422PF32LE,  ///< IEEE-754 single precision planar YUV 4:2:2, 64bpp, (1 Cr & Cb sample per 2x1 Y samples), little-endian
    AV_PIX_FMT_YUV422PF32BE,  ///< IEEE-754 single precision planar YUV 4:2:2, 64bpp, (1 Cr & Cb sample per 2x1 Y samples), big-endian

    AV_PIX_FMT_YUV444PF32LE,  ///< IEEE-754 single precision planar YUV 4:4:4, 96bpp, (1 Cr & Cb sample per 1x1 Y samples), little-endian
    AV_PIX_FMT_YUV444PF32BE,  ///< IEEE-754 single precision planar YUV 4:4:4, 96bpp, (1 Cr & Cb sample per 1x1 Y samples), big-endian

    AV_PIX_FMT_YUVA420PF32LE,  ///< IEEE-754 single precision planar YUV 4:2:0, 48bpp, (1 Cr & Cb sample per 2x2 Y samples), 32b alpha, little-endian
    AV_PIX_FMT_YUVA420PF32BE,  ///< IEEE-754 single precision planar YUV 4:2:0, 48bpp, (1 Cr & Cb sample per 2x2 Y samples), 32b alpha, big-endian

    AV_PIX_FMT_YUVA422PF32LE,  ///< IEEE-754 single precision planar YUV 4:2:2, 64bpp, (1 Cr & Cb sample per 2x1 Y samples), 32b alpha, little-endian
    AV_PIX_FMT_YUVA422PF32BE,  ///< IEEE-754 single precision planar YUV 4:2:2, 64bpp, (1 Cr & Cb sample per 2x1 Y samples), 32b alpha, big-endian

    AV_PIX_FMT_YUVA444PF32LE,  ///< IEEE-754 single precision planar YUV 4:4:4, 96bpp, (1 Cr & Cb sample per 1x1 Y samples), 32b alpha, little-endian
    AV_PIX_FMT_YUVA444PF32BE,  ///< IEEE-754 single precision planar YUV 4:4:4, 96bpp, (1 Cr & Cb sample per 1x1 Y samples), 32b alpha, big-endian
...
#define AV_PIX_FMT_YUVA422P14 AV_PIX_FMT_NE(YUVA422P14BE, YUVA422P14LE)
#define AV_PIX_FMT_YUVA444P14 AV_PIX_FMT_NE(YUVA444P14BE, YUVA444P14LE)
...
#define AV_PIX_FMT_YUVA420PF32 AV_PIX_FMT_NE(YUVA420PF32BE, YUVA420PF32LE)
#define AV_PIX_FMT_YUVA422PF32 AV_PIX_FMT_NE(YUVA422PF32BE, YUVA422PF32LE)
#define AV_PIX_FMT_YUVA444PF32 AV_PIX_FMT_NE(YUVA444PF32BE, YUVA444PF32LE)
