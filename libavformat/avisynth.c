...
static int avisynth_create_stream_video(AVFormatContext *s, AVStream *st)
{
    ...
    case AVS_CS_YUVA422P12:
        ...
        planar               = 4;
        break;
    case AVS_CS_YUVA420P12:
        st->codecpar->format = AV_PIX_FMT_YUVA420P12;
        planar               = 4;
        break;
    case AVS_CS_YUVA444P14:
        st->codecpar->format = AV_PIX_FMT_YUVA444P14;
        planar               = 4;
        break;
    case AVS_CS_YUVA422P14:
        st->codecpar->format = AV_PIX_FMT_YUVA422P14;
        planar               = 4;
        break;
    ...
    case AVS_CS_YUV422PS:
        ...
        planar               = 1;
        break;
    case AVS_CS_YUV420PS:
        st->codecpar->format = AV_PIX_FMT_YUV420PF32;
        planar               = 1;
        break;
    /* Single precision floating point YUV pix_fmts with Alpha (AviSynth+) */
    case AVS_CS_YUVA444PS:
        st->codecpar->format = AV_PIX_FMT_YUVA444PF32;
        planar               = 4;
        break;
    case AVS_CS_YUVA422PS:
        st->codecpar->format = AV_PIX_FMT_YUVA422PF32;
        planar               = 4;
        break;
    case AVS_CS_YUVA420PS:
        st->codecpar->format = AV_PIX_FMT_YUVA420PF32;
        planar               = 4;
        break;
